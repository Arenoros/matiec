...
/* Compile with the following option, to print out the const_value of each symbol, which was filled in by
 * constant_folding_c during stage3 */
...
private:
    ...
    void* print_binary_expression(symbol_c* symbol, symbol_c* l_exp, symbol_c* r_exp, const char* operation) {
    ...
    void* print_unary_expression(symbol_c* symbol, symbol_c* exp, const char* operation) {
        print_const_value(symbol);
        s4o.print(operation);
        exp->accept(*this);
        return NULL;
...
void *visit(eno_param_c *symbol) {
  return symbol->param_name->accept(*this);
    ...
    /* 2.1.6 Pragmas  */
    /******************/
    void* visit(enable_code_generation_pragma_c*) {
        s4o.print("{enable code generation}");
        return NULL;
    }
    void* visit(disable_code_generation_pragma_c*) {
        s4o.print("{disable code generation}");
        return NULL;
    }
    ...
    void* visit(neg_real_c* symbol) {
        return print_unary_expression(symbol, symbol->exp, "-");
    }
    ...
    void* visit(safestring_type_name_c* symbol) {
        s4o.print("SAFESTRING");
        return NULL;
    }
    void* visit(safewstring_type_name_c* symbol) {
        s4o.print("SAFEWSTRING");
        return NULL;
    }
    ...
    */
    ...
    void* visit(il_expression_c* symbol) {
         ...
         * simple_instr_list will be the equivalent and artificial 'LD <il_operand>' IL instruction. Since we do not
         * want the extra LD instruction, we simply remove it!
         */
        if (symbol->il_operand != NULL)
    ...
    void* visit(deref_operator_c* symbol) {
        ...
        s4o.print("^");
    } /* an extension to the IEC 61131-3 standard - based on the IEC 61131-3 v3 standard. ^      -> dereferences an
         address into a variable! */
    void* visit(deref_expression_c* symbol) {
        return s4o.print("DREF(");
        symbol->exp->accept(*this);
        s4o.print(")");
    } /* an extension to the IEC 61131-3 standard - based on the IEC 61131-3 v3 standard. DREF() -> dereferences an
         address into a variable! */
    void* visit(ref_expression_c* symbol) {
        return s4o.print("REF(");
        symbol->exp->accept(*this);
        s4o.print(")");
    } /* an extension to the IEC 61131-3 standard - based on the IEC 61131-3 v3 standard. REF()  -> returns address of
         the varible! */
    void* visit(or_expression_c* symbol) {
        return print_binary_expression(symbol, symbol->l_exp, symbol->r_exp, " OR ");
    }
    void* visit(xor_expression_c* symbol) {
        return print_binary_expression(symbol, symbol->l_exp, symbol->r_exp, " XOR ");
    }
    void* visit(and_expression_c* symbol) {
        return print_binary_expression(symbol, symbol->l_exp, symbol->r_exp, " AND ");
    }
    ...
    void* visit(mod_expression_c* symbol) {
        return print_binary_expression(symbol, symbol->l_exp, symbol->r_exp, " MOD ");
    }
    ...
    void* visit(not_expression_c* symbol) {
        return print_unary_expression(symbol, symbol->exp, "NOT ");
    }
