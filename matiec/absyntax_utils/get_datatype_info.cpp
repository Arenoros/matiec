...
#include "main.h"  // required for ERROR() and ERROR_MSG() macros, as well as the runtime_options global variable
...
public:
    static symbol_c* get_id(symbol_c* symbol) {
        if (NULL == singleton)
            singleton = new get_datatype_id_c();
        if (NULL == singleton)
            ERROR;
...
protected:
    ...
    void* visit(void_type_name_c* symbol) {
        return (void*)symbol;
    };
    ...
    void* visit(simple_type_declaration_c* symbol) {
        return symbol->simple_type_name;
    }
    /*  subrange_type_name ':' subrange_spec_init */
    void* visit(subrange_type_declaration_c* symbol) {
        return symbol->subrange_type_name;
    }
    /*  enumerated_type_name ':' enumerated_spec_init */
    void* visit(enumerated_type_declaration_c* symbol) {
        return symbol->enumerated_type_name;
    }
    ...
    void* visit(structure_type_declaration_c* symbol) {
        return symbol->structure_type_name;
    }
    /*  string_type_name ':' elementary_string_type_name string_type_declaration_size string_type_declaration_init */
    void* visit(string_type_declaration_c* symbol) {
        return symbol->string_type_name;
    }
    /* ref_type_decl: identifier ':' ref_spec_init */
    void* visit(ref_type_decl_c* symbol) {
        return symbol->ref_type_name;
    }
    /* NOTE: DO NOT place any code here that references symbol->anotations_map["generate_c_annotaton__implicit_type_id"]
     * !! All anotations in the symbol->anotations_map[] are considered a stage4 construct. In the above example, That
     * anotation is specific to the generate_c stage4 code, and must therefore NOT be referenced in the absyntax_utils
     * code, as this last code should be independent of the stage4 version!
     */
    ...
    void* visit(program_declaration_c* symbol) {
        return symbol->program_type_name;
    }
...
public:
    static const char* get_id_str(symbol_c* symbol) {
        if (NULL == singleton)
            singleton = new get_datatype_id_str_c;
        if (NULL == singleton)
            ERROR;
    ...
    void* visit(safetime_type_name_c* symbol) {
        return (void*)"SAFETIME";
    };
    void* visit(safebool_type_name_c* symbol) {
        return (void*)"SAFEBOOL";
    };
    void* visit(safesint_type_name_c* symbol) {
        return (void*)"SAFESINT";
    };
    void* visit(safeint_type_name_c* symbol) {
        return (void*)"SAFEINT";
    };
    void* visit(safedint_type_name_c* symbol) {
        return (void*)"SAFEDINT";
    };
    void* visit(safelint_type_name_c* symbol) {
        return (void*)"SAFELINT";
    };
    void* visit(safeusint_type_name_c* symbol) {
        return (void*)"SAFEUSINT";
    };
    void* visit(safeuint_type_name_c* symbol) {
        return (void*)"SAFEUINT";
    };
    void* visit(safeudint_type_name_c* symbol) {
        return (void*)"SAFEUDINT";
    };
    void* visit(safeulint_type_name_c* symbol) {
        return (void*)"SAFEULINT";
    };
    void* visit(safereal_type_name_c* symbol) {
        return (void*)"SAFEREAL";
    };
    void* visit(safelreal_type_name_c* symbol) {
        return (void*)"SAFELREAL";
    };
    void* visit(safedate_type_name_c* symbol) {
        return (void*)"SAFEDATE";
    };
    void* visit(safetod_type_name_c* symbol) {
        return (void*)"SAFETOD";
    };
    ...
    void* visit(safebyte_type_name_c* symbol) {
        return (void*)"SAFEBYTE";
    };
    void* visit(safeword_type_name_c* symbol) {
        return (void*)"SAFEWORD";
    };
    void* visit(safelword_type_name_c* symbol) {
        return (void*)"SAFELWORD";
    };
    void* visit(safedword_type_name_c* symbol) {
        return (void*)"SAFEDWORD";
    };
    void* visit(safestring_type_name_c* symbol) {
        return (void*)"SAFESTRING";
    };
    void* visit(safewstring_type_name_c* symbol) {
        return (void*)"SAFEWSTRING";
    };
    ...
    /*  simple_type_name ':' simple_spec_init */
    void* visit(simple_type_declaration_c* symbol) {
        return symbol->simple_type_name->accept(*this);
    }
    /*  subrange_type_name ':' subrange_spec_init */
    void* visit(subrange_type_declaration_c* symbol) {
        return symbol->subrange_type_name->accept(*this);
    }
    /*  enumerated_type_name ':' enumerated_spec_init */
    void* visit(enumerated_type_declaration_c* symbol) {
        return symbol->enumerated_type_name->accept(*this);
    }
    /*  identifier ':' array_spec_init */
    void* visit(array_type_declaration_c* symbol) {
        return symbol->identifier->accept(*this);
    }
    /*  structure_type_name ':' structure_specification */
    void* visit(structure_type_declaration_c* symbol) {
    ...
    /*  FUNCTION derived_function_name ':' elementary_type_name io_OR_function_var_declarations_list function_body
     * END_FUNCTION */
    void* visit(function_declaration_c* symbol) {
        return symbol->derived_function_name->accept(*this);
    }
    /*****************************/
    /* B 1.5.2 - Function Blocks */
    /*****************************/
     ...
     */
    void* visit(function_block_declaration_c* symbol) {
        return symbol->fblock_name->accept(*this);
    }
    /**********************/
    /* B 1.5.3 - Programs */
    /**********************/
    /*  PROGRAM program_type_name program_var_declarations_list function_block_body END_PROGRAM */
    void* visit(program_declaration_c* symbol) {
        return symbol->program_type_name->accept(*this);
    }
};
...
private:
    ...
    /********************************/
    /*  structure_type_name ':' structure_specification */
    /* NOTE: this is only used inside a TYPE ... END_TYPE declaration.  It is never used directly when declaring a new
     * variable! */
    /* NOTE: structure_specification will point to either initialized_structure_c  OR
    ...
    void* visit(initial_step_c* symbol) {
        ...
        if (compare_identifiers(&T, current_field) == 0)
            return &get_datatype_info_c::time_type_name;
        if (compare_identifiers(&X, current_field) == 0)
            return &get_datatype_info_c::bool_type_name;
        return NULL;
    }

    /* STEP step_name ':' action_association_list END_STEP */
    // SYM_REF2(step_c, step_name, action_association_list)
    /* The code here should be identicial to the code in the visit(initial_step_c *) visitor! So we simply call the
     * other visitor! */
...
symbol_c* get_datatype_info_c::get_array_storedtype_id(symbol_c* type_symbol) {
    ...
    if (NULL == symbol)
        symbol = dynamic_cast<array_specification_c*>(type_symbol);
    if (NULL == symbol)
        symbol = dynamic_cast<array_specification_c*>(search_base_type_c::get_basetype_decl(type_symbol));
    if (NULL != symbol)
...
bool get_datatype_info_c::is_type_equal(symbol_c* first_type, symbol_c* second_type) {
    if (!is_type_valid(first_type)) {
        return false;
    }
    if (!is_type_valid(second_type)) {
        return false;
    }

    /* GENERIC DATATYPES */
    /* For the moment, we only support the ANY generic datatype! */
    if ((is_ANY_generic_type(first_type)) || (is_ANY_generic_type(second_type))) {
        return true;
    }

    /* ANY_ELEMENTARY */
    if ((is_ANY_ELEMENTARY_compatible(first_type)) && (typeid(*first_type) == typeid(*second_type))) {
        return true;
    }
    if (is_ANY_ELEMENTARY_compatible(first_type) || is_ANY_ELEMENTARY_compatible(second_type)) {
        return false;
    }
    ...
    /*if (false == runtime_options.relaxed_datatype_model) {
        return false;
    }*/

    // check for array equivalence usig the relaxed datatype model
    if (is_arraytype_equal_relaxed(first_type, second_type)) {
        return true;
    }
...
static std::string normalize_subrange_limit(symbol_c* symbol) {
     ...
     *           (e.g: the POU containing a VAR_EXTERN is not instantiated, and that external variable is used to define
     * a limit of an array (ARRAY of [1..ext_var] OF INT) However, currently get_datatype_info_c::is_type_equal() is not
     * called to handle the above case, and constant_folding is being called before all algorithms that call
     * get_datatype_info_c::is_type_equal(), which means that the following code is really not needed. But it is best to
    ...
    if (NULL != symconst)
        token = dynamic_cast<token_c*>(symconst->var_name);
    if (NULL != symvar)
        token = dynamic_cast<token_c*>(symvar->var_name);
    if (NULL != token)
...
bool get_datatype_info_c::is_arraytype_equal_relaxed(symbol_c* first_type, symbol_c* second_type) {
    ...
    if ((NULL == subrange_list_1) || (NULL == subrange_list_2))
        ERROR;
    if (subrange_list_1->size() != subrange_list_2->size())
        return false;

    // comparison of each subrange start and end elements
    for (int i = 0; i < subrange_list_1->size(); i++) {
        ...
        if ((NULL == subrange_1) || (NULL == subrange_2))
            ERROR;

        /* check whether the subranges have the same values, using the result of the constant folding agorithm.
         * This method has the drawback that it inserts a dependency on having to run the constant folding algorithm
         * before the get_datatype_info_c::is_type_equal() method is called. This is why we implement an alternative
         * method in case the subrange limits have not yet been reduced to a cvalue!
         */
        if ((subrange_1->lower_limit->const_value._int64v.is_valid() ||
             subrange_1->lower_limit->const_value._uint64.is_valid()) &&
            (subrange_2->lower_limit->const_value._int64v.is_valid() ||
             subrange_2->lower_limit->const_value._uint64.is_valid()) &&
            (subrange_1->upper_limit->const_value._int64v.is_valid() ||
             subrange_1->upper_limit->const_value._uint64.is_valid()) &&
            (subrange_2->upper_limit->const_value._int64v.is_valid() ||
             subrange_2->upper_limit->const_value._uint64.is_valid())) {
            if (!(subrange_1->lower_limit->const_value == subrange_2->lower_limit->const_value))
                return false;
            if (!(subrange_1->upper_limit->const_value == subrange_2->upper_limit->const_value))
                return false;
        } else {
            // NOTE: nocasecmp_c() class is defined in absyntax.hh. nocasecmp_c() instantiates an object, and
            // nocasecmp_c()() uses the () operator on that object.
            if (!nocasecmp_c()(normalize_subrange_limit(subrange_1->lower_limit),
                               normalize_subrange_limit(subrange_2->lower_limit)))
                return false;
            if (!nocasecmp_c()(normalize_subrange_limit(subrange_1->upper_limit),
...
bool get_datatype_info_c::is_ref_to(symbol_c* type_symbol) {
    ...
    if (typeid(*type_decl) == typeid(ref_type_decl_c)) {
        return true;
    } /* identifier ':' ref_spec_init */
    if (typeid(*type_decl) == typeid(ref_spec_init_c)) {
        return true;
    } /* ref_spec [ ASSIGN ref_initialization ]; */
    if (typeid(*type_decl) == typeid(ref_spec_c)) {
        return true;
...
bool get_datatype_info_c::is_sfc_initstep(symbol_c* type_symbol) {
    ...
    if (typeid(*type_decl) == typeid(initial_step_c)) {
        return true;
    } /* INITIAL_STEP step_name ':' action_association_list END_STEP */ /* A pseudo data type! */
    return false;
}
...
bool get_datatype_info_c::is_sfc_step(symbol_c* type_symbol) {
    ...
    if (typeid(*type_decl) == typeid(step_c)) {
        return true;
    } /*         STEP step_name ':' action_association_list END_STEP */ /* A pseudo data type! */
    return false;
}
...
bool get_datatype_info_c::is_function_block(symbol_c* type_symbol) {
    ...
    if (typeid(*type_decl) == typeid(function_block_declaration_c)) {
        return true;
    } /*  FUNCTION_BLOCK derived_function_block_name io_OR_other_var_declarations function_block_body END_FUNCTION_BLOCK
       */
    return false;
...
bool get_datatype_info_c::is_subrange(symbol_c* type_symbol) {
    symbol_c* type_decl = search_base_type_c::get_equivtype_decl(
        type_symbol); /* NOTE: do NOT call search_base_type_c !! */
    if (NULL == type_decl) {
        return false;
    }

    if (typeid(*type_decl) == typeid(subrange_type_declaration_c)) {
        return true;
    } /*  subrange_type_name ':' subrange_spec_init */
    if (typeid(*type_decl) == typeid(subrange_spec_init_c)) {
        return true;
    } /* subrange_specification ASSIGN signed_integer */
    if (typeid(*type_decl) == typeid(subrange_specification_c)) {
        return true;
    } /*  integer_type_name '(' subrange')' */

    if (typeid(*type_decl) == typeid(subrange_c)) {
        ERROR;
...
bool get_datatype_info_c::is_enumerated(symbol_c* type_symbol) {
    ...
    if (typeid(*type_decl) == typeid(enumerated_type_declaration_c)) {
        return true;
    } /*  enumerated_type_name ':' enumerated_spec_init */
    if (typeid(*type_decl) == typeid(enumerated_spec_init_c)) {
        return true;
    } /* enumerated_specification ASSIGN enumerated_value */
    if (typeid(*type_decl) == typeid(enumerated_value_list_c)) {
        return true;
    } /* enumerated_value_list ',' enumerated_value */ /* once we change the way we handle enums, this will probably
                                                          become an ERROR! */

    if (typeid(*type_decl) == typeid(enumerated_value_c)) {
        ERROR;
...
bool get_datatype_info_c::is_array(symbol_c* type_symbol) {
    ...
    if (typeid(*type_decl) == typeid(array_type_declaration_c)) {
        return true;
    } /*  identifier ':' array_spec_init */
    if (typeid(*type_decl) == typeid(array_spec_init_c)) {
        return true;
    } /* array_specification [ASSIGN array_initialization} */
    if (typeid(*type_decl) == typeid(array_specification_c)) {
        return true;
    } /* ARRAY '[' array_subrange_list ']' OF non_generic_type_name */

    if (typeid(*type_decl) == typeid(array_subrange_list_c)) {
        ERROR;
    } /* array_subrange_list ',' subrange */
    if (typeid(*type_decl) == typeid(array_initial_elements_list_c)) {
        ERROR;
    } /* array_initialization:  '[' array_initial_elements_list ']' */ /* array_initial_elements_list ','
                                                                          array_initial_elements */
    if (typeid(*type_decl) == typeid(array_initial_elements_c)) {
        ERROR;
...
bool get_datatype_info_c::is_structure(symbol_c* type_symbol) {
    ...
    if (typeid(*type_decl) == typeid(structure_type_declaration_c)) {
        return true;
    } /*  structure_type_name ':' structure_specification */
    if (typeid(*type_decl) == typeid(initialized_structure_c)) {
        return true;
    } /* structure_type_name ASSIGN structure_initialization */
    if (typeid(*type_decl) == typeid(structure_element_declaration_list_c)) {
        return true;
    } /* structure_declaration:  STRUCT structure_element_declaration_list END_STRUCT */ /* structure_element_declaration_list
                                                                                            structure_element_declaration
                                                                                            ';' */

    if (typeid(*type_decl) == typeid(structure_element_declaration_c)) {
        ERROR;
    } /*  structure_element_name ':' *_spec_init */
    if (typeid(*type_decl) == typeid(structure_element_initialization_list_c)) {
        ERROR;
    } /* structure_initialization: '(' structure_element_initialization_list ')' */ /* structure_element_initialization_list
                                                                                       ','
                                                                                       structure_element_initialization
                                                                                     */
    if (typeid(*type_decl) == typeid(structure_element_initialization_c)) {
        ERROR;
    } /*  structure_element_name ASSIGN value */
    return false;
}
...
bool get_datatype_info_c::is_ANY_generic_type(symbol_c* type_symbol) {
    ...
    if (typeid(*type_decl) == typeid(generic_type_any_c)) {
        return true;
    } /*  The ANY keyword! */
    return false;
}
...
bool get_datatype_info_c::is_ANY_ELEMENTARY(symbol_c* type_symbol) {
    ...
    if (is_ANY_MAGNITUDE(type_symbol)) {
        return true;
    }
    if (is_ANY_BIT(type_symbol)) {
        return true;
    }
    if (is_ANY_STRING(type_symbol)) {
        return true;
    }
    if (is_ANY_DATE(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_SAFEELEMENTARY(symbol_c* type_symbol) {
    ...
    if (is_ANY_SAFEMAGNITUDE(type_symbol)) {
        return true;
    }
    if (is_ANY_SAFEBIT(type_symbol)) {
        return true;
    }
    if (is_ANY_SAFESTRING(type_symbol)) {
        return true;
    }
    if (is_ANY_SAFEDATE(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_ELEMENTARY_compatible(symbol_c* type_symbol) {
    ...
    if (is_ANY_ELEMENTARY(type_symbol)) {
        return true;
    }
    if (is_ANY_SAFEELEMENTARY(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_MAGNITUDE(symbol_c* type_symbol) {
    ...
    if (is_TIME(type_symbol)) {
        return true;
    }
    if (is_ANY_NUM(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_SAFEMAGNITUDE(symbol_c* type_symbol) {
    ...
    if (is_SAFETIME(type_symbol)) {
        return true;
    }
    if (is_ANY_SAFENUM(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_signed_MAGNITUDE(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(time_type_name_c)) {
        return true;
    }
    if (is_ANY_signed_NUM(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_signed_MAGNITUDE_compatible(symbol_c* type_symbol) {
    ...
    if (is_ANY_signed_MAGNITUDE(type_symbol)) {
        return true;
    }
    if (is_ANY_signed_SAFEMAGNITUDE(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_NUM(symbol_c* type_symbol) {
    ...
    if (is_ANY_REAL(type_symbol)) {
        return true;
    }
    if (is_ANY_INT(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_SAFENUM(symbol_c* type_symbol) {
    ...
    if (is_ANY_SAFEREAL(type_symbol)) {
        return true;
    }
    if (is_ANY_SAFEINT(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_signed_NUM(symbol_c* type_symbol) {
    ...
    if (is_ANY_signed_INT(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_signed_SAFENUM(symbol_c* type_symbol) {
    ...
    if (is_ANY_signed_SAFEINT(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_signed_NUM_compatible(symbol_c* type_symbol) {
    ...
    if (is_ANY_signed_SAFENUM(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_INT(symbol_c* type_symbol) {
    ...
    if (is_ANY_unsigned_INT(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_SAFEINT(symbol_c* type_symbol) {
    ...
    if (is_ANY_unsigned_SAFEINT(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_signed_INT(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(sint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(int_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(dint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(lint_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_signed_SAFEINT(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(safesint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safeint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safedint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safelint_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_unsigned_INT(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(usint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(uint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(udint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(ulint_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_unsigned_SAFEINT(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(safeusint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safeuint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safeudint_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safeulint_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_REAL(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(lreal_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_SAFEREAL(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(safereal_type_name_c)) {
        return true;
    }
...
bool get_datatype_info_c::is_ANY_nBIT(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(byte_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(word_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(dword_type_name_c)) {
        return true;
    }
...
bool get_datatype_info_c::is_ANY_SAFEnBIT(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(safeword_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safedword_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safelword_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_nBIT_compatible(symbol_c* type_symbol) {
    ...
    if (is_ANY_nBIT(type_symbol)) {
        return true;
    }
    if (is_ANY_SAFEnBIT(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_BOOL(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(bool_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_SAFEBOOL(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(safebool_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_BOOL_compatible(symbol_c* type_symbol) {
    ...
    if (is_BOOL(type_symbol)) {
        return true;
    }
    if (is_SAFEBOOL(type_symbol)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_DATE(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(date_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(tod_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(dt_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_SAFEDATE(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(safedate_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safetod_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safedt_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_STRING(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(string_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(wstring_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_SAFESTRING(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(safestring_type_name_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(safewstring_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_VOID(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(void_type_name_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_REAL_literal(symbol_c* type_symbol) {
    if (type_symbol == NULL) {
        return true;
    } /* Please make sure things will work correctly before changing this to false!! */
    if (typeid(*type_symbol) == typeid(real_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(neg_real_c)) {
        return true;
    }
    return false;
}
...
bool get_datatype_info_c::is_ANY_INT_literal(symbol_c* type_symbol) {
    ...
    if (typeid(*type_symbol) == typeid(integer_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(neg_integer_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(binary_integer_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(octal_integer_c)) {
        return true;
    }
    if (typeid(*type_symbol) == typeid(hex_integer_c)) {
        return true;
    }
    return false;
}
